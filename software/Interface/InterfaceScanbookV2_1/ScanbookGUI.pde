...
private int pctWidth = 400;
private int pctWidth2 = 200;
private int pctHeight = 400;
...
private PImage picture,picture1,picture2,picture3;

// INIT
void initGui()
 {
   widthW = ((2*pctWidth)+(2*pctWidth2)+(5*space));
...
void loadPictures()
 {
   picture = loadPicture("PageTest.png",pctWidth,pctHeight);
   picture1 = loadPicture("PageTest.png",pctWidth,pctHeight);
   picture2 = loadPicture("PageTest.png",pctWidth2,pctHeight);
   picture3 = loadPicture("PageTest.png",pctWidth2,pctHeight);
 }
 
PImage loadPicture(String path,int w,int h)
 {
...
void drawControl()
 {
   ...
   btnNextPage = drawButton("NextPage",0,pctPosX,(pctPosY+pctHeight+space),pctWidth2,btnHeight);
   btnDetect = drawButton("Detect",0,pctPosX,(pctPosY+pctHeight+space),pctWidth2,btnHeight);
   pctPosX = pctPosX + space + pctWidth2;
   drawPicture(picture3,pctPosX,pctPosY);
   btnFinLivre = drawButton("FinLivre",0,pctPosX,(pctPosY+pctHeight+space),pctWidth2,btnHeight);
   btnManuel = drawButton("Manuel",0,pctPosX,(pctPosY+pctHeight+space),pctWidth2,btnHeight);
 }
