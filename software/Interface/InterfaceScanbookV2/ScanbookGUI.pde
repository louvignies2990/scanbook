...
// Objets graphiques
private Button btnStart,btnValider,btnFinLivre,btnNextPage;
...
void drawControl()
 {
   ...
   btnFinLivre = drawButton("FinLivre",0,(pctPosX+pctWidth2-btnWidth),(pctPosY+pctHeight+space),pctWidth2,btnHeight);
 }
